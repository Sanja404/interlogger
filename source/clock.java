/* autogenerated by Processing revision 1293 on 2023-12-07 */
...
public void setup() {
  ...
  pozX=90;
  pozY=105;
  internalPressure=705.0f;
  internalTemperature=3.0f;
  //холст
  b1 = color(255);
  b2 = color(150);
  c1 = color(204, 102, 0);
  ...
  am.setMinScaleValue(700.0f);
  am.setMaxScaleValue(800.0f);
  ...
  an.setMinScaleValue(0.0f);
  an.setMaxScaleValue(40.0f);
...
public void draw() {
  ...
  if (reset == true) {
    println("Reset");
    am.setMaximumValue(-0.f-1f);
    am.setMinimumValue(0.1f);
    an.setMaximumValue(-0.f-1f);
...
//}
  ...
  public void settings() { size(1050, 300); }
